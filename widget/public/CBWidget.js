...
var cbwidget = (function () {
  ...
  // (16:35) {#each selectedSeat as item}
  function create_each_block_1(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block_1.name, type: "each", source: "(16:35) {#each selectedSeat as item}", ctx });
  	return block;
  }

  // (20:4) {#each $seating as seat (seat.id)}
  function create_each_block(key_1, ctx) {
  	...
  	const block = {
  		...
  		c: function create() {
  			...
  			add_location(div0, file, 21, 8, 588);
  			attr_dev(div1, "class", "seating__col p-1 d-flex");
  			add_location(div1, file, 20, 6, 542);
  	...
  	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(20:4) {#each $seating as seat (seat.id)}", ctx });
  	return block;
  }
  ...
  function create_fragment(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div0, file, 14, 0, 297);
  			attr_dev(div1, "class", "mb-3");
  			add_location(div1, file, 15, 0, 333);
  			attr_dev(div2, "class", "d-flex flex-wrap");
  			add_location(div2, file, 18, 2, 466);
  			attr_dev(section, "class", "section section_seating");
  			add_location(section, file, 17, 0, 422);
  		},
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t_1 = space();
  			seating.$$.fragment.c();
  			add_location(h1, file$1, 16, 4, 310);
  			attr_dev(div0, "class", "modal-dialog");
  			attr_dev(div0, "role", "document");
  			add_location(div0, file$1, 15, 2, 263);
  			attr_dev(div1, "class", "modal fade");
  			attr_dev(div1, "id", "exampleModalLong");
  			attr_dev(div1, "tabindex", "-1");
  			attr_dev(div1, "role", "dialog");
  			attr_dev(div1, "aria-labelledby", "exampleModalLongTitle");
  			attr_dev(div1, "aria-hidden", "true");
  			add_location(div1, file$1, 8, 0, 115);
  		},
  ...
  class App extends SvelteComponentDev {
  	constructor(options) {
  		...
  		if (ctx.CBID === undefined && !('CBID' in props)) {
  			console_1.warn("<App> was created without expected prop 'CBID'");
  		}
  	}
