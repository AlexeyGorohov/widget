...
var cbwidget = (function () {
  ...
  // (18:35) {#each selectedSeat as item}
  function create_each_block_1(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block_1.name, type: "each", source: "(18:35) {#each selectedSeat as item}", ctx });
  	return block;
  }

  // (22:4) {#each $seating as seat (seat.id)}
  function create_each_block(key_1, ctx) {
  	...
  	const block = {
  		...
  		c: function create() {
  			...
  			add_location(div0, file, 23, 8, 622);
  			attr_dev(div1, "class", "seating__col p-1 d-flex");
  			add_location(div1, file, 22, 6, 576);
  	...
  	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(22:4) {#each $seating as seat (seat.id)}", ctx });
  	return block;
  }
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t_1 = space();
  			seating.$$.fragment.c();
  			add_location(h1, file$1, 9, 4, 162);
  			attr_dev(div0, "class", "modal");
  			add_location(div0, file$1, 8, 2, 138);
  			attr_dev(div1, "class", "widget-cb");
  			add_location(div1, file$1, 7, 0, 112);
  		},
  ...
  function instance$1($$self, $$props, $$invalidate) {
  	...
  	const writable_props = ['CBID', 'btns'];
  	...
  	$$self.$set = $$props => {
  		...
  		if ('btns' in $$props) $$invalidate('btns', btns = $$props.btns);
  	};
  ...
  class App extends SvelteComponentDev {
  	constructor(options) {
  		super(options);
  		init(this, options, instance$1, create_fragment$1, safe_not_equal, ["CBID", "btns"]);
  		...
  		if (ctx.btns === undefined && !('btns' in props)) {
  			console.warn("<App> was created without expected prop 'btns'");
  		}
  	}
