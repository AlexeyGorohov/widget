...
var app = (function () {
  ...
  const seating = seatingCreate();

  /* src\view\seating\Seating.svelte generated by Svelte v3.12.1 */

  const file = "src\\view\\seating\\Seating.svelte";
  ...
  // (18:4) {#each $seating as seat (seat.id)}
  function create_each_block(key_1, ctx) {
  	...
  	const block = {
  		...
  		c: function create() {
  			...
  			t0 = text(t0_value);
  			t1 = space();
  			attr_dev(div0, "class", "seating__item p-2 w-100 text-center border border-succes rounded\n          cursor-pointer");
  			toggle_class(div0, "disabled", ctx.seat.disabled);
  			add_location(div0, file, 19, 8, 494);
  			attr_dev(div1, "class", "seating__col p-1 d-flex");
  			add_location(div1, file, 18, 6, 448);
  	...
  	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(18:4) {#each $seating as seat (seat.id)}", ctx });
  	return block;
  }

  function create_fragment(ctx) {
  	var div0, t0, t1, t2, div1, t4, section, div2, each_blocks = [], each_1_lookup = new Map();
  	...
  	const block = {
  		c: function create() {
  			...
  			t2 = space();
  			div1 = element("div");
  			div1.textContent = "Выбранные места:";
  			t4 = space();
  			...
  			add_location(div0, file, 12, 0, 248);
  			attr_dev(div1, "class", "mb-3");
  			add_location(div1, file, 13, 0, 285);
  			attr_dev(div2, "class", "d-flex flex-wrap");
  			add_location(div2, file, 16, 2, 372);
  			attr_dev(section, "class", "section section_seating");
  			add_location(section, file, 15, 0, 328);
  		},
  		...
  		p: function update(changed, ctx) {
  			...
  			each_blocks = update_keyed_each(each_blocks, changed, get_key, 1, ctx, each_value, each_1_lookup, div2, destroy_block, create_each_block, null, get_each_context);
  		},
  ...
  function instance($$self, $$props, $$invalidate) {
  	...
  	component_subscribe($$self, sum, $$value => { $sum = $$value; $$invalidate('$sum', $sum); });
  	...
  	$$self.$inject_state = $$props => {
  		if ('$sum' in $$props) sum.set($sum);
  		if ('$seating' in $$props) seating.set($seating);
  	};

  	return { $sum, $seating, click_handler };
  }
  ...
  class Seating extends SvelteComponentDev {
  	constructor(options) {
  		...
  		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Seating", options, id: create_fragment.name });
  	}
  }
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t_1 = space();
  			seating.$$.fragment.c();
  			add_location(h1, file$1, 7, 2, 116);
  			attr_dev(main, "class", "p-2");
  			add_location(main, file$1, 6, 0, 95);
  		},
